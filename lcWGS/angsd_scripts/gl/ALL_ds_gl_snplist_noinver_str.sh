...
#SBATCH --job-name=ALL_ds_pca_snplist_noinver_str.sh # job name
...
#SBATCH --output=ALL_ds_pca_snplist_noinver_str_maf0.05_pind0.86.out.%j # write stdout+stderr to this file; %j will be automatically replaced by the job ID
...
OUTBASE=$target"_maf"$MIN_MAF"_pval"$PV"_pind"$PERCENT_IND"_cv30_noinver"
