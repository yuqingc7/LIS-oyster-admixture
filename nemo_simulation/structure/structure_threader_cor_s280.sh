...
echo "low differentiation"
for ADMIX in "single0.1" "single0.2" "single0.5" "single0.8"; do
	echo "scenario $ADMIX"
	for AD_GEN in 10681 10682 10683 10684 10686 10691 10696 10701; do
		...
		for REP in {01..10}; do
			...
			# run software
			/home/yc2644/.local/bin/structure_threader run -i $WORKDIR"structure/"$PREFIX"/threader_input/"$PREFIX".n"$NUMIND".str" -o $WORKDIR"structure/"$PREFIX -st /programs/structure_2_3_4/bin/structure -K 2 -R 10 -t 8 --log true --ind $WORKDIR"structure/indfile_n"$NUMIND".txt" --params $WORKDIR"structure/mainparams"
